...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
   const ref = useRef(null)
    ...
    return (
    <section ref={ref} className="bg-gray-100 group max-w-[42rem] relative boorder border-black/5 even:pl-8 hover:bg-gray-200 transition  overflow-hidden sm:pr-8 sm:h-[20rem] mb-3 sm:mb-8 last:mb-0">
